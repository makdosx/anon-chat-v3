...
//print_r($yourbrowser);
 ...
 //echo $yourbrowser;
    ...
    if ($ua['name']=='Internet explorer' && $ua['version']<'IE 7')
      {
       header('Location: browser_update.php');
       }    


  else  if ($ua['name']=='Mozilla Firefox' && $ua['version']<'30.0')
      {
       header('Location: browser_update.php');
       }      
  ...
  else if ($ua['name']=='Opera' && $ua['version']<'15.0')
      {
       header('Location: browser_update.php');
       }    


  else if ($ua['name']=='Google Chrome' && $ua['version']<'32.0.1700')
      {
       header('Location: browser_update.php');
       }    
  ...
  else if ($ua['name']=='Apple safari' && $ua['version']<'7.0')
      {
       header('Location: browser_update.php');
       }    


  else if ($ua['name']=='Netscape' && $ua['version']<'6.0B1')
      {
       header('Location: browser_update.php');
       }    
