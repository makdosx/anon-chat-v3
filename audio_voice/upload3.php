...
$sql7="select id2 from chat where fingerprint='$finger'";
  ...
  //$sql8="INSERT INTO chat (multimedia_data) VALUES('$multimedia_data')";
  //$result8=$conn->query($sql8);

  $session_login = $_SESSION['login'];

  $sql9="update chat set id2 = '$id4',  _from = '$session_login', ip_from = '$ip_from3', _to = 'chat',
